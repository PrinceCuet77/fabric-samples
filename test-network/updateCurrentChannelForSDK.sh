...
/home/prince-11209/Desktop/Fabric/RnD-Task/fabric-samples/bin/peer chaincode query -C channelforcustomcc -n invoketrack -c '{"Args":["GetCurrentChannelID"]}' >&updateCurrentChannelForSDKlog.txt

cat updateCurrentChannelForSDKlog.txt
